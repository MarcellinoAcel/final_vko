...
def generate_launch_description():
    ...
    ekf_config_path = PathJoinSubstitution(
        [FindPackageShare("robot_properties"), "config", "ekf.yaml"]
    )
    ...
    description_launch_path = PathJoinSubstitution(
        [FindPackageShare('robot_properties'), 'launch', 'description.launch.py']
    )
    twist_mux_params = PathJoinSubstitution(
        [FindPackageShare("robot_properties"), 'config', 'twist_mux.yaml']
    )
